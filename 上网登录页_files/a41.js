...
var redirectLink="http://nic.glut.edu.cn/nic/annc";// 登录重定向

var rebackLink="http://202.193.80.125/a79.htm?isReback=1";//返回重定向
...
var eportalv6=1;// //0不显示加载v6参数，1显示加载v6参数
...
var radiusIP="202.193.80.124";//RADIUS服务器IP
...
var enableR3=1; // 是否启用 r3 参数区分多运营商

var webPayUrl="http://222.203.32.5:8080/WebPay/toRecharge"; // 充值链接

var isLang=1; //是否启动中英文 1-启用 0-关闭
